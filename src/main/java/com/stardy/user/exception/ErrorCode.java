...
public enum ErrorCode {
    ...
    DUPLICATED_PROVIDER(HttpStatus.BAD_REQUEST, "DUPLICATED_PROVIDER", "이미 연결된 소셜 계정입니다."),
    ...
    USER_ALREADY_INACTIVE(HttpStatus.BAD_REQUEST, "USER_ALREADY_INACTIVE", "이미 탈퇴한 사용자입니다."),
